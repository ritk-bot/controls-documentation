...
The guide to tuning is in [PID Controller](Robotic%20Arm/Controls/PID%20Controller.md). Today i just tuned the shoulder joint and the params on my dummy arm were:
```
